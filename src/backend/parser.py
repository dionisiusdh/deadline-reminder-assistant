...
# ===== KEYWORDS =====
keywords_task = ["Kuis", "Ujian", "Tucil", "Tubes", "Praktikum", "Tugas", "PR", "Ulangan"]
...
def case_add_task(x):
    ...
    listPreposition = get_all_same_pattern(preposition_keywords, x) # Masih asumsi hanya ada satu preposisi
